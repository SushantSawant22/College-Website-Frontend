            ...
            <div>
                <nav class="navbar background">
                    ...
                    <div class="rightNav">
                        ...
                        <button class="btn btn-sm" id='btn'>Search</button>
                    </div>
                </nav>
                    ...
                    <div class="box-main">
                        <div class="firstHalf">
                            <h1 class="text-big">
                                ...
                                course Search in 2022
                            </h1>
                            <p class="text-small">
                                Hunting down a relevant course requires
                                proper technique. But with
                                the advent of COVID-19, it has become
                                a bit challenging and competitive to
                                reach out for your dream course.
                                .
                            </p>
                        </div>
                    </div>
